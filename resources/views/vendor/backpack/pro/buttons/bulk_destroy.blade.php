@if ($crud->hasAccess('bulkDestroy') && $crud->get('list.bulkActions'))
	<a href="javascript:void(0)" onclick="bulkDestroyEntries(this)" class="btn btn-sm btn-secondary bulk-button trash-button delete-trash-button"><i class="la la-fire-alt"></i> {{ trans('backpack/pro::trash.destroy') }}</a>
@endif
