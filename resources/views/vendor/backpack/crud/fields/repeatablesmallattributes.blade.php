...
<div class="container-repeatable-elements">
    ...
    <div class="col-md-12 well repeatable-element-smallattributes row m-1 p-2" data-repeatable-identifier="{{ $field['name'] }}">
        @if (isset($field['subfields']) && is_array($field['subfields']) && count($field['subfields']))
            ...
            @foreach ($field['subfields'] as $subfield)
                @php
                    ...
                    //   dd($subfield);
                    $subfield['options'] = $field['options'] ?? null;
                    $fieldViewNamespace = $subfield['view_namespace'] ?? 'crud::fields';
                    $fieldViewPath = $fieldViewNamespace . '.' . $subfield['type'];
                    if ($subfield['type'] == 'relationship') {
                        $fieldViewPath = $fieldViewNamespace . '.' . $subfield['type'].'_smallattributes';
                    }
