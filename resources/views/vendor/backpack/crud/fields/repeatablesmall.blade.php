...
<div class="container-repeatable-elements">
    ...
    <div class="col-md-12 well repeatable-element-small row m-1 p-2" data-repeatable-identifier="{{ $field['name'] }}">
            ...
            @foreach ($field['subfields'] as $subfield)
                @php
                    ...
                    if ($subfield['type'] == 'relationship') {
                        $fieldViewNamespace = $subfield['view_namespace'] ?? 'crud::fields';
                    // $fieldViewPath = $fieldViewNamespace . '.' . $subfield['type'];
                        $fieldViewPath = $fieldViewNamespace . '.' . $subfield['type'].'_small';
                    }
                    else continue;
