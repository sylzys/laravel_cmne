@if ($crud->hasAccess('bulkRestore') && $crud->get('list.bulkActions'))
	<a href="javascript:void(0)" onclick="bulkRestoreEntries(this)" class="btn btn-sm btn-secondary bulk-button trash-button"><i class="la la-recycle"></i> {{ trans('backpack/pro::trash.restore') }}</a>
@endif
